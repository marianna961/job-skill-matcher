...
Определение рейтинга университета
...
Обучение модели происходит с использованием класса `Trainer`, который управляет процессом обучения, оценки и сохранения модели.
